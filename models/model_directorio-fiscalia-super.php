...
class class_directorio_fiscalia_super extends class_datos
{

    //========== MÉTODOS ==========//

    function consultar_fiscalia_superior($conection, $busqueda, $tabla)
    {
        ...
        foreach ($fila as $key => $value) {
            $this->consultar($conection, $busqueda, $tabla, "WHERE  id_superior='$value'");
            $i = 1;
            $a++;
