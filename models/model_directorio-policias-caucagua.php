...
class class_policias_caucagua extends class_datos
{

    //========== MÉTODOS ==========//

    function consultar_policias_caucagua($conection, $busqueda, $tabla)
    {
        ...
        foreach ($fila as $key => $value) {
            $this->consultar($conection, $busqueda, $tabla, "WHERE  id_caucagua='$value'");
            $i = 1;
            $a++;
            $this->multi_buscar .=
                '<div class="form-row">
    ...
    function policias_caucagua_miranda($conection, $busqueda, $tabla)
    {
        $fila = $_POST['fila'];

        $a = 0;
        foreach ($fila as $key => $value) {
            $this->consultar($conection, $busqueda, $tabla, "WHERE  id_policias_caucagua='$value'");
            $i = 1;
            $a++;
            $this->multi_buscar .=
                '<div class="form-row">
