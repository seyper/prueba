...
class class_policias_charallave extends class_datos
{

    //========== MÉTODOS ==========//

    function consultar_policias_charallave($conection, $busqueda, $tabla)
    {
        ...
        foreach ($fila as $key => $value) {
            $this->consultar($conection, $busqueda, $tabla, "WHERE  id_charallave='$value'");
            $i = 1;
            $a++;
            $this->multi_buscar .=
                '<div class="form-row">
    ...
    function policias_charallave_miranda($conection, $busqueda, $tabla)
    {
        $fila = $_POST['fila'];

        $a = 0;
        foreach ($fila as $key => $value) {
            $this->consultar($conection, $busqueda, $tabla, "WHERE  id_policias_charallave='$value'");
            $i = 1;
            $a++;
            $this->multi_buscar .=
                '<div class="form-row">
