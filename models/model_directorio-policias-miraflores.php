...
class class_policias_miraflores extends class_datos
{

    //========== MÉTODOS ==========//

    function consultar_policias_miraflores($conection, $busqueda, $tabla)
    {
        ...
        foreach ($fila as $key => $value) {
            $this->consultar($conection, $busqueda, $tabla, "WHERE  id_miraflores='$value'");
            $i = 1;
            $a++;
            $this->multi_buscar .=
                '<div class="form-row">
